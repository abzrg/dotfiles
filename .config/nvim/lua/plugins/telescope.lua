...
vim.api.nvim_set_keymap('n', '\\\\', '<Cmd>Telescope buffers<CR>',
                        {silent = true, noremap = true})
vim.api.nvim_set_keymap('n', ';;', '<Cmd>Telescope help_tags<CR>',
                        {silent = true, noremap = true})
vim.api.nvim_set_keymap('n', ';h', '<Cmd>Telescope man_pages<CR>',
                        {silent = true, noremap = true})
...
vim.api.nvim_set_keymap("n", "<leader>nb",
...
-- Grep neovim configs
vim.api.nvim_set_keymap("n", "<leader>vg",
